...
<template>
  <div class="app-container">
    ...
    <el-table-column
      ...
      label="身份证号码"
      width="250"
      column-key="loan_card"
      >
    </el-table-column>
    <el-table-column label="操作" width="250">
      <template slot-scope="{row}">
        <el-button
          size="mini" type="primary" @click="handleUpdate(row)"  
          >查看</el-button>
        <el-button
          size="mini"
          type="danger" @click="handleDel(row)" 
          >通过</el-button>
          <el-button
...
<script>
import {approveEndList,loanQuery,loanDelete,loanUpdate} from '@/api/article'
import {sexOptions,educationOptions} from '@/util/selectData'
